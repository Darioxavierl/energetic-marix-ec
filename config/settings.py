...
# MANUAL entry baseline policy
MANUAL_BASELINE_SNAPSHOT_MAX_AGE_MINUTES = 30.0
MANUAL_ENTRY_HYDRO_NEUTRALIZE_ON_SWITCH = True
MANUAL_ENTRY_HYDRO_NEUTRAL_RESERVOIR_PCT = 100.0
MANUAL_LIVE_ENERGY_WINDOW_HOURS = 24.0

# Charts panel settings
CHART_HISTORY_MAX_POINTS = 120

# Diagnostics
MODE_SWITCH_DIAGNOSTICS_ENABLED = True
